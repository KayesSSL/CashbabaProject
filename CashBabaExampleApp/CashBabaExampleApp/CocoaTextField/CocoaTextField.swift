...
public class CocoaTextField: UITextField {
    ...
    */
    ...
    // MARK: - Access changed to internal (or omitted, default is internal)
    var isHintVisible = false
    let hintLabel = UILabel()
    let errorLabel = UILabel()
    
    let padding: CGFloat = 16
    let hintFont = UIFont.systemFont(ofSize: 12)
    var initialBoundsWereCalculated = false
